...
%% distance
ax1 = subplot(411);
plot(t_ba.secs(k_ba_start:k_ba_end),t_ba.km(k_ba_start:k_ba_end)*1000,'color',cBA,'linewidth',w1)
hold on
plot(t_n1.secs(k_n1_start:k_n1_end),t_n1.km(k_n1_start:k_n1_end)*1000,'color',cN1,'linewidth',w1)
plot(t_n2.secs(k_n2_start:k_n2_end),t_n2.km(k_n2_start:k_n2_end)*1000,'color',cN1,'linewidth',w1)
plot(t_r1.secs(k_r1_start:k_r1_end),t_r1.km(k_r1_start:k_r1_end)*1000,'color',cR1,'linewidth',w1)
plot(t_n3.secs(k_n3_start:k_n3_end),t_n3.km(k_n3_start:k_n3_end)*1000,'color',cN2,'linewidth',w1)
plot(t_n4.secs(k_n4_start:k_n4_end),t_n4.km(k_n4_start:k_n4_end)*1000,'color',cN1,'linewidth',w1)
plot(t_r2.secs(k_r2_start:k_r2_end),t_r2.km(k_r2_start:k_r2_end)*1000,'color',cR1,'linewidth',w1)
plot(t_tt.secs(k_tt_start:k_tt_end),t_tt.km(k_tt_start:k_tt_end)*1000,'color',cTT,'linewidth',w1)
...
%% velocity
ax2 = subplot(412);
% plot(t_ba.secs(k_ba_start:k_ba_end),movmean(t_ba.kph(k_ba_start:k_ba_end)/3.6,[4 0]),'color',cBA,'linewidth',w1)
% hold on
% plot(t_n1.secs(k_n1_start:k_n1_end),movmean(t_n1.kph(k_n1_start:k_n1_end)/3.6,[4 0]),'color',cN1,'linewidth',w1)
% plot(t_n2.secs(k_n2_start:k_n2_end),movmean(t_n2.kph(k_n2_start:k_n2_end)/3.6,[4 0]),'color',cN1,'linewidth',w1)
% plot(t_r1.secs(k_r1_start:k_r1_end),movmean(t_r1.kph(k_r1_start:k_r1_end)/3.6,[4 0]),'color',cR1,'linewidth',w1)
% plot(t_n3.secs(k_n3_start:k_n3_end),movmean(t_n3.kph(k_n3_start:k_n3_end)/3.6,[4 0]),'color',cN2,'linewidth',w1)
% plot(t_n4.secs(k_n4_start:k_n4_end),movmean(t_n4.kph(k_n4_start:k_n4_end)/3.6,[4 0]),'color',cN1,'linewidth',w1)
% plot(t_r2.secs(k_r2_start:k_r2_end),movmean(t_r2.kph(k_r2_start:k_r2_end)/3.6,[4 0]),'color',cR1,'linewidth',w1)
% plot(t_tt.secs(k_tt_start:k_tt_end),movmean(t_tt.kph(k_tt_start:k_tt_end)/3.6,[4 0]),'color',cTT,'linewidth',w1)

plot(t_ba.secs(k_ba_start:k_ba_end),t_ba.kph(k_ba_start:k_ba_end)/3.6,'color',cBA,'linewidth',w1)
hold on
plot(t_n1.secs(k_n1_start:k_n1_end),t_n1.kph(k_n1_start:k_n1_end)/3.6,'color',cN1,'linewidth',w1)
plot(t_n2.secs(k_n2_start:k_n2_end),t_n2.kph(k_n2_start:k_n2_end)/3.6,'color',cN1,'linewidth',w1)
plot(t_r1.secs(k_r1_start:k_r1_end),t_r1.kph(k_r1_start:k_r1_end)/3.6,'color',cR1,'linewidth',w1)
plot(t_n3.secs(k_n3_start:k_n3_end),t_n3.kph(k_n3_start:k_n3_end)/3.6,'color',cN2,'linewidth',w1)
plot(t_n4.secs(k_n4_start:k_n4_end),t_n4.kph(k_n4_start:k_n4_end)/3.6,'color',cN1,'linewidth',w1)
plot(t_r2.secs(k_r2_start:k_r2_end),t_r2.kph(k_r2_start:k_r2_end)/3.6,'color',cR1,'linewidth',w1)
plot(t_tt.secs(k_tt_start:k_tt_end),t_tt.kph(k_tt_start:k_tt_end)/3.6,'color',cTT,'linewidth',w1)
...
plot(t_ba.secs(k_ba_start:k_ba_end),t_ba.watts(k_ba_start:k_ba_end),'color',cBA,'linewidth',w1)
hold on
plot(t_n1.secs(k_n1_start:k_n1_end),t_n1.watts(k_n1_start:k_n1_end),'color',cN1,'linewidth',w1)
plot(t_n2.secs(k_n2_start:k_n2_end),t_n2.watts(k_n2_start:k_n2_end),'color',cN1,'linewidth',w1)
plot(t_r1.secs(k_r1_start:k_r1_end),t_r1.watts(k_r1_start:k_r1_end),'color',cR1,'linewidth',w1)
plot(t_n3.secs(k_n3_start:k_n3_end),t_n3.watts(k_n3_start:k_n3_end),'color',cN2,'linewidth',w1)
plot(t_n4.secs(k_n4_start:k_n4_end),t_n4.watts(k_n4_start:k_n4_end),'color',cN1,'linewidth',w1)
plot(t_r2.secs(~k_r2),t_r2.watts(~k_r2),'color',cR1,'linewidth',w1)
plot(t_tt.secs(~k_tt),t_tt.watts(~k_tt),'color',cTT,'linewidth',w1)
